...
#                len_sofa += len(s['tokens'])
            ...
            for e in d['edgeSet']:
                ...
                if 'ignore' in e:
                  data_now['relations'][-1].append('ignore')
...
def prepare_data_seq(batch_size=1, shuffle=True, Debug="False", training=True, lw = None, lr = None, data_type="data1", suffix = ""):
    
    # determine which dataset to use
#    if training:
#        if Debug == 'True':
#            file_train = './utils/debug.json'
#        else:
#            file_train = './utils/train_length_250_350_top100_relation_s20_w70_r_seperate_mini.json'
#    else:
#        if Debug == 'True':
#            file_train = './utils/debug_test.json'
#        else:
#            file_train = './utils/test_length_250_350_top100_relation_s20_w70_r_seperate_mini.json'

    if training:
      file_train = './utils/{}{}_train.json'.format("", data_type)
    else:
      file_train = './utils/{}{}_test.json'.format(suffix, data_type)
